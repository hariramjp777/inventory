...
@WebServlet("/receive-purchase-order")
public class ReceivePurchaseOrderServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!Authentication.isAuthenticated(request)) {
            ...
            try {
                ...
                JSONObject resultJSON = purchaseOrderDAO.receivePurchaseOrder(organizationID, purchaseOrderID);
