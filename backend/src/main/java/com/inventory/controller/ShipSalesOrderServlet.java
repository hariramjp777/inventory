...
@WebServlet("/ship-sales-order")
public class ShipSalesOrderServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!Authentication.isAuthenticated(request)) {
            ...
            try {
                ...
                JSONObject resultJSON = salesOrderDAO.shipSalesOrder(organizationID, salesOrderID);
