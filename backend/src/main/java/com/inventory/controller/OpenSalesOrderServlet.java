...
@WebServlet("/open-sales-order")
public class OpenSalesOrderServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!Authentication.isAuthenticated(request)) {
            ...
            try {
                ...
                JSONObject resultJSON = salesOrderDAO.openSalesOrder(organizationID, salesOrderID);
