...
@WebServlet("/bill-purchase-order")
public class BillPurchaseOrderServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!Authentication.isAuthenticated(request)) {
            ...
            try {
                ...
                JSONObject resultJSON = purchaseOrderDAO.billPurchaseOrder(organizationID, purchaseOrderID);
